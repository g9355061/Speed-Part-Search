...
> 最後更新：2026-05-30（新增快取料件風險動態重算機制、缺料預測機制改名、類別特定庫存門檻與交期判定邏輯優化、RSS 預警天數調整為 14 天、新增每日快照與歷史趨勢預警機制、新增新聞與 PCN 生命週期分類小標籤及快速篩選過濾連結、新增安全與補貨水位定義懸浮提示、修復 Railway 部署路徑解析錯誤、新增 15 類別水位對照表）
